...
func wrapComboBox(obj *glib.Object) *ComboBox {
	bin := wrapBin(obj)
	cl := wrapCellLayout(*glib.InterfaceFromObjectNew(obj))
...
func (v *ComboBox) SetIDColumn(id int) {
	C.gtk_combo_box_set_id_column(v.native(), C.gint(id))
}
...
func (v *ComboBoxText) native() *C.GtkComboBoxText {
	...
	ptr := unsafe.Pointer(v.Object.Native())
	return C.toGtkComboBoxText(ptr)
}
